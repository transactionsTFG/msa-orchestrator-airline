...
public class UpdateFlightInstanceRollbackByEventCreateReservation extends BaseEventHandler {
    ...
    public EventId sendEventId() {
        return EventId.FLIGHT_UPDATE_FLIGHT_AIRLINE_CREATE_RESERVATION_ROLLBACK_SAGA;
    }
}
