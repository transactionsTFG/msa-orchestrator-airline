...
public class FlightValidateByEventModifyReservation  extends BaseEventHandler {
    ...
    public EventId sendEventId() {
        return EventId.FLIGHT_VALIDATE_FLIGHT_RESERVATION_AIRLINE_MODIFY_RESERVATION;
    }
}
